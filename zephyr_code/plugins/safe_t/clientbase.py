...
from zephyr_code.util import UserCancelled
from zephyr_code.keystore import bip39_normalize_passphrase
from zephyr_code.bip32 import BIP32Node, convert_bip32_path_to_list_of_uint32
    ...
    def callback_PassphraseRequest(self, req):
        ...
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the PIVX coins in the wallet.").format(self.device)
        else:
...
class SafeTClientBase(GuiMixin, Logger):
    ...
    def has_usable_connection_with_device(self):
        try:
            res = self.ping("zephyr pinging device")
            assert res == "zephyr pinging device"
