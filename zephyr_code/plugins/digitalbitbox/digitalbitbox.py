...
from zephyr_code.crypto import sha256d, EncodeAES_base64, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from zephyr_code.bitcoin import (TYPE_ADDRESS, push_script, var_int, public_key_to_p2pkh,
                                   is_address)
from zephyr_code.bip32 import BIP32Node
from zephyr_code import ecc
from zephyr_code.ecc import msg_magic
from zephyr_code.wallet import Standard_Wallet
from zephyr_code import constants
from zephyr_code.transaction import Transaction
from zephyr_code.i18n import _
from zephyr_code.keystore import Hardware_KeyStore
from ..hw_wallet import HW_PluginBase
from zephyr_code.util import to_string, UserCancelled, UserFacingException
...
class DigitalBitbox_Client():
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("PIVX-Electrum-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
