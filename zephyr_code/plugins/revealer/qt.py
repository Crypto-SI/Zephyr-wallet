...
from zephyr_code.util import make_dir, InvalidPassword, UserCancelled
from zephyr_code.gui.qt.util import (read_QIcon, EnterButton, WWLabel, icon_path,
                                       WindowModalDialog, Buttons, CloseButton, OkButton)
from zephyr_code.gui.qt.qrtextedit import ScanQRTextEdit
from zephyr_code.gui.qt.main_window import StatusBarButton
...
class Plugin(RevealerPlugin):
    ...
    def password_dialog(self, msg=None, parent=None):
        from zephyr_code.gui.qt.password_dialog import PasswordDialog
    ...
    def overlay_marks(self, img, is_cseed=False, calibration_sheet=False):
        ...
        if not calibration_sheet:
            if is_cseed: #its a secret
                painter.setPen(QPen(Qt.black, 1, Qt.PIVXDotDotLine))
