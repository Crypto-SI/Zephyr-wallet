...
from zephyr_code.bitcoin import (TYPE_ADDRESS, int_to_hex, var_int,
...
from zephyr_code.util import bfh, bh2u, versiontuple, UserFacingException
from zephyr_code.base_wizard import ScriptTypeNotSupported
...
class Ledger_Client():
    def __init__(self, hidDevice):
        self.dongleObject = btchip_pivx(hidDevice)
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise UserFacingException(_("Device not in pivx mode")) from e
                raise e
