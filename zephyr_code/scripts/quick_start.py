...
from zephyr_code.daemon import Daemon
from zephyr_code.storage import WalletStorage
from zephyr_code.wallet import Wallet, create_new_wallet
from zephyr_code.commands import Commands


config = SimpleConfig({"testnet": True})  # to use ~/.zephyr_code/testnet as datadir
