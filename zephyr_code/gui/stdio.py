...
from zephyr_code import WalletStorage, Wallet
...
from zephyr_code.network import TxBroadcastError, BestEffortRequestFailed
...
class ElectrumGui:
    ...
    def network_dialog(self):
        print("use 'zephyr setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'zephyr setconfig' to change your settings")
        return True
