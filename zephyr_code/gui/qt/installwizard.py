...
from zephyr_code.wallet import Wallet, Abstract_Wallet
from zephyr_code.storage import WalletStorage
from zephyr_code.util import UserCancelled, InvalidPassword, WalletFileException
from zephyr_code.base_wizard import BaseWizard, HWD_SETUP_DECRYPT_WALLET, GoBack
...
WIF_HELP_TEXT = (_('WIF keys are typed in Zephyr, based on script type.') + '\n\n' +
                 _('A few examples') + ':\n' +
...
MSG_PASSPHRASE_WARN_ISSUE4566 = _("Warning") + ": "\
                              ...
                              + _("Due to a bug, old versions of Zephyr will NOT be creating the "
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins):
        ...
        self.setWindowTitle('Zephyr  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
    ...
    def select_storage(self, path, get_wallet_from_daemon) -> Tuple[str, Optional[WalletStorage]]:
        ...
        self.set_layout(vbox, title=_('zephyr wallet'))
    ...
    def run_upgrades(self, storage):
        ...
        if storage.requires_split():
            self.hide()
            msg = _("The wallet '{}' contains multiple accounts, which are no longer supported since Zephyr 2.7.\n\n"
    ...
    def init_network(self, network):
        message = _("Zephyr communicates with remote servers to get "
                  "information about your transactions and addresses. The "
                  "servers all fulfill the same purpose only differing in "
                  "hardware. In most cases you simply want to let Zephyr "
