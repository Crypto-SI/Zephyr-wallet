"""PIVX look and feel (dark style)."""

import os
from zephyr_code.util import pkg_dir
...
QComboBox::down-arrow {
    border-image: url({pkg_dir}/gui/icons/pivx_downArrow.png) 0 0 0 0 stretch stretch;
}
...
QAbstractSpinBox::up-button {
    ...
    background: #232629;
    border-left:0px;
    border-right:1px solid #565082;
    border-top:1px solid #565082;
    border-bottom:0px;
    padding-right:1px;
    padding-left:5px;
    padding-top:2px;
...
QAbstractSpinBox::down-button {
    ...
    border-left:0px;
    border-right:1px solid #565082;
    border-bottom:1px solid #565082;
    padding-right:1px;
    padding-left:5px;
    padding-bottom:2px;
}
...
QAbstractSpinBox::up-arrow {
    image: url({pkg_dir}/gui/icons/pivx_upArrow_small.png);
    width: 10px;
    height: 10px;
}

QAbstractSpinBox::up-arrow:disabled, QAbstractSpinBox::up-arrow:off {
    image: url({pkg_dir}/gui/icons/pivx_upArrow_small_disabled.png);
}

QAbstractSpinBox::down-arrow {
    image: url({pkg_dir}/gui/icons/pivx_downArrow_small.png);
    width: 10px;
    height: 10px;
}

QAbstractSpinBox::down-arrow:disabled, QAbstractSpinBox::down-arrow:off {
    image: url({pkg_dir}/gui/icons/pivx_downArrow_small_disabled.png);
}
...
QHeaderView::section { /* Table Header Sections */
    ...
    background-color:#9590bb;;
    color:#fff;
    font-weight:bold;
    font-size:11px;
    outline:0;
    border:0;
    border-right:1px solid #9590bb;
    padding-left:2px;
    padding-right:10px;
    padding-top:1px;
    padding-bottom:1px;
...
QScrollBar:up-arrow {
    background-image: url({pkg_dir}/gui/icons/pivx_upArrow_small.png);
}

QScrollBar:down-arrow {
    background-image: url({pkg_dir}/gui/icons/pivx_downArrow_small.png);
}

QScrollBar:left-arrow {
    background-image: url({pkg_dir}/gui/icons/pivx_leftArrow_small.png);
}

QScrollBar:right-arrow {
    background-image: url({pkg_dir}/gui/icons/pivx_rightArrow_small.png);
}
...
pivx_stylesheet = pivx_stylesheet.replace('{pkg_dir}', '%s' % pkg_dir_for_css)
