...
from zephyr_code import version
from zephyr_code import constants
from zephyr_code import ecc
from zephyr_code.i18n import _
from zephyr_code.util import make_aiohttp_session
from zephyr_code.logging import Logger


class UpdateCheck(QWidget, Logger):
    url = "https://raw.githubusercontent.com/mrcarlanthony/Zephyr-wallet/master/.latest-version"
    download_url = "https://github.com/mrcarlanthony/Zephyr-wallet/releases"
    ...
    def __init__(self, main_window, latest_version=None):
        ...
        self.setWindowTitle('Zephyr - ' + _('Update Check'))
    ...
    def update_view(self, latest_version=None):
        if latest_version:
            ...
            if self.is_newer(latest_version):
                ...
                self.detail_label.setText(_("You are already on the latest version of Zephyr."))
        else:
            self.heading_label.setText('<h2>' + _("Checking for updates...") + '</h2>')
            self.detail_label.setText(_("Please wait while Zephyr checks for available updates."))
