...
from zephyr_code.bitcoin import (public_key_to_p2pkh, address_from_private_key,
...
from zephyr_code.bip32 import (BIP32Node, convert_bip32_intpath_to_strpath,
                                 xpub_from_xprv, xpub_type, is_xprv, is_bip32_derivation,
                                 is_xpub, convert_bip32_path_to_list_of_uint32,
                                 normalize_bip32_derivation)
from zephyr_code.crypto import sha256d, SUPPORTED_PW_HASH_VERSIONS
from zephyr_code import ecc, crypto, constants
from zephyr_code.ecc import number_to_string, string_to_number
from zephyr_code.util import bfh, bh2u, InvalidPassword
from zephyr_code.storage import WalletStorage
from zephyr_code.keystore import xtype_from_derivation, from_master_key

from zephyr_code import ecc_fast

from zephyr_code.tests.cases import SequentialTestCase
from zephyr_code.tests.cases import TestCaseForTestnet
from zephyr_code.tests.cases import FAST_TESTS
...
class Test_bitcoin_testnet(TestCaseForTestnet):
    ...
    def test_address_to_script(self):
        # base58 P2PKH
        self.assertEqual(address_to_script('yBMRBKE55McHL4SL3nHjZYTvnHcxNCZ18K'), '76a9149da64e300c5e4eb4aaffc9c2fd465348d5618ad488ac')
        self.assertEqual(address_to_script('xzJn9TopM6Sfm8qkGycsdBkH57LgBFJjbG'), '76a914247d2d5b6334bdfa2038e85b20fc15264f8e5d2788ac')
...
class Test_xprv_xpub(SequentialTestCase):
    ...
    xprv_xpub = (
        {'xprv': 'ToEA6epvY6iUs9r4QP4tkWhqMS6w41PBs6vgjSGtjZGsea1M1W49FRcCWWEeLX5imWRTPcEa5navHfj3u1doNVnfwt3JG78rafcdQj6FqbcDXHn',
         'xpub': 'TDt9EWvD5T5T44hAZuJZXMfHWGsmD66d1YWTp7CVhrX1zjHNuB3VYXnbaKZ2HUkx5KoCtby3iwJaVT7Tn3Cr4vQ9vy5LfFiiqS6cUJfY8HTHzr4',
         'xtype': 'standard'},
    )
    ...
    def test_bip32(self):
        ...
        self.assertEqual("TDt9EhvBdbUrYWbp2eF1KfsTK4rurMJUCjbzWQP8XSvaNBkX742fkg2aqZ4dFmuc5TREEaPnHyA5pJcnc9gZJFQv5qnySuMbzM3kXGoHJYV7jUi", xpub)
        self.assertEqual("ToEA6qpu6F7tMbkhs81LYpv1AE65hGb34J2DRjTXZ9gS22UVDP3KTZrBmjkFJoZejhKe2zGJgzQdS6PMCNVJZzaoHW2BY6ojQ3XEk6HFm6qzadL", xprv)

        xpub, xprv = self._do_test_bip32("fffcf9f6f3f0edeae7e4e1dedbd8d5d2cfccc9c6c3c0bdbab7b4b1aeaba8a5a29f9c999693908d8a8784817e7b7875726f6c696663605d5a5754514e4b484542","m/0/2147483647'/1/2147483646'/2")
        self.assertEqual("TDt9Egh3tBvjDCGVQBR2WrUNadUw1B21Sa47eRE8PDxAEweyenEn9pDXnWrzH4V4bAgWwBwdjNx4g1K3CmbTBmN8CbrtmFghgZKXcoh8Dt8KCDy", xpub)
        self.assertEqual("ToEA6pbmLqZm2HRPEfBMk1WvRni6r6JaJ8ULZkJXQvi1tnNwm7FRri38ihYcL6kpkDw68xsrHJsuo3pnhm9X6nLM91vtWz4FcUAbKuCR2UekBVm", xprv)
...
#Commented until we have proper vectors.
"""
